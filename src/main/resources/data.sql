...
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (402, 1, 1, TO_TIMESTAMP('03/APR/2018 2:00:00'), TO_TIMESTAMP('03/APR/2018 3:00:00'));
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (403, 1, 1, TO_TIMESTAMP('09/APR/2018 3:00:00'), TO_TIMESTAMP('09/APR/2018 4:00:00'));       
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (404, 1, 1, TO_TIMESTAMP('10/APR/2018 4:00:00'), TO_TIMESTAMP('10/APR/2018 5:00:00'));

INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (405, 1, 2, TO_TIMESTAMP('02/APR/2019 1:00:00'), TO_TIMESTAMP('02/APR/2019 2:00:00'));
...
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (407, 1, 2, TO_TIMESTAMP('09/APR/2019 3:00:00'), TO_TIMESTAMP('09/APR/2019 4:00:00'));       
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (408, 1, 2, TO_TIMESTAMP('10/APR/2019 4:00:00'), TO_TIMESTAMP('10/APR/2019 5:00:00'));

INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (409, 2, 1, TO_TIMESTAMP('02/APR/2020 1:00:00'), TO_TIMESTAMP('02/APR/2020 2:00:00'));
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (410, 2, 1, TO_TIMESTAMP('03/APR/2020 2:00:00'), TO_TIMESTAMP('03/APR/2020 3:00:00'));
...
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (412, 2, 1, TO_TIMESTAMP('10/APR/2020 4:00:00'), TO_TIMESTAMP('10/APR/2020 5:00:00'));

INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (413, 2, 2, TO_TIMESTAMP('02/APR/2021 1:00:00'), TO_TIMESTAMP('02/APR/2021 2:00:00'));
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (414, 2, 2, TO_TIMESTAMP('03/APR/2021 2:00:00'), TO_TIMESTAMP('03/APR/2021 3:00:00'));
INSERT INTO SCHEDULED_DATE (ID, WEEK, DAY, START_TIME, END_TIME) VALUES (415, 2, 2, TO_TIMESTAMP('09/APR/2021 3:00:00'), TO_TIMESTAMP('09/APR/2021 4:00:00'));       
